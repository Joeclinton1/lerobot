...
@dataclass
class BiGemNeckConfig:
    """BiGEM neck servos on the shared Feetech bus."""
...
class BiGemFollowerConfig(RobotConfig):
    """Bimanual GEM follower: shared Feetech bus, two SteadyWin ODrive buses, optional neck."""
    ...
    neck: BiGemNeckConfig | None = field(default_factory=BiGemNeckConfig)
